...
<div class="row">
	<div class="col-md-10 offset-md-1">
		...
		<form action="/laporan/result_tanggal" method="post">
		{{ method_field('patch') }}
		<div class="form-inline" id="tgl">
		...
		<br>
		<h1 class="text-center">Laporan Data Parkiran <b>Parkir.In</b></h1>
		<hr>
		<br>
		<p>Laporan Tanggal : {{ $start }} - {{ $end }}</p>
		<table class="table table-bordered table-striped">
			...
			<tbody>
				@if (count($data) <= 0)
					<tr>
						<td class="text-center" colspan="8">Data Empty</td>
					</tr>
				@else
